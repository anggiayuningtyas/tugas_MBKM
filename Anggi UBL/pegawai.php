...
class Pegawai
{
    ...
    // Const & Static
    static $no = 0;
    const PT = 'PT. Anggi Ayu Ningtyas Sejahtera';
    ...
    public function cetak()
    {
        ...
        <div class="col mb-3 mx-0">
            ...
            <h5 class="card-title text-center text-yellow p-1 mb-0 bg-success small">No. ' . self::$no . '</h5>
                <div class="card-body">
                ...
                <h5 class="card-title text-center text-light bg-black text-muted p-1 small">' . self::PT . '</h5>
            </div>
        </div>
        ';
    }
